...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Selamat datang di Halaman Admin Chetak's</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>
                <?php 
                  $res = $db->prepare('SELECT COUNT(*) FROM pemesanan where status_pemesanan = 1');
                  $res->execute();
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php 
                  $res = $db->prepare('SELECT COUNT(*) FROM pemesanan where status_pemesanan = 2');
                  $res->execute();
                  $num_rows = $res->fetchColumn(); 
                  echo $num_rows?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php 
                  $res = $db->prepare('SELECT COUNT(*) FROM pemesanan where status_pemesanan = 3');
                  $res->execute();
                  $num_rows = $res->fetchColumn(); 
                  echo $num_rows?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?php 
                  $res = $db->prepare('SELECT COUNT(*) FROM pemesanan where status_pemesanan = 4');
                  $res->execute();
                  $num_rows = $res->fetchColumn(); 
                  echo $num_rows?></h3>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="http://adminlte.io">E - Chetak's</a>.</strong>
    All rights reserved.
