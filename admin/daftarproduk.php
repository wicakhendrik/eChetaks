                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 250px;">
                    ...
                    <div class="input-group-append">
                      ...
                      <a href="tambahproduk.php" type="button" class="btn btn-primary">Tambah Produk</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <img src="../img/product/<?php echo $data['gambar_produk']; ?>" height="100px" width="100px"> 
                      </td>
                      <td><?php echo $data['harga']; ?></td>
                      <td> 
                        <div class="btn-group">
                          <a href="editproduk.php?id=<?php echo $data["id_produk"]; ?>" type="button" class="btn btn-primary">Edit Produk</a>
                        </div> 
                        <div class="btn-group">
                          <a href="../function/deleteProduct.php?id=<?php echo $data["id_produk"]; ?>" type="button" class="btn btn-danger">Hapus Produk</a>
                        </div> 
                      </td>
                    </tr>
                  <?php } ?>
